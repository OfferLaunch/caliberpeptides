...
export const metadata = {
  title: 'Privacy Policy | Caliber Labs',
  description: 'Privacy Policy for Caliber Labs',
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-lg max-w-none font-body text-espresso/80 space-y-6">
            <section>
              ...
              <p>
                Caliber Labs ("Company," "we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                If Caliber Labs is involved in a merger, acquisition, bankruptcy, dissolution, reorganization, similar transaction or proceeding, your information may be part of the assets transferred.
              </p>
            </section>
