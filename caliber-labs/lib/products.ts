...
export const products: Product[] = [
  ...
  },
  {
    ...
    slug: 'wolverine',
    category: 'Specialty Blends',
    catalogSubtitle: 'BPC-157 + TB-500 Blend (10/10mg)',
    purity: 99.0,
    price: 89.99,
    form: 'Lyophilized Powder',
    ...
    researchFindings: [
      {
        title: 'Systematic Review of BPC-157 in Musculoskeletal Applications',
        protocol: 'Systematic review compiled 544 published studies from 1993 to 2024, evaluating 36 that met rigorous inclusion criteria across musculoskeletal research applications. Studies evaluated across muscle, tendon, ligament, and bone models. Protocol range assessed: 6 mcg/kg to 20 mg/kg.',
        effects: 'Consistent improvements in structural, functional, and biomechanical outcomes reported across all tissue types. No toxic protocol threshold identified across the full range evaluated. Assessments across liver, kidney, brain, lung, and reproductive tissue reported no significant findings outside normal parameters.',
        citation: 'Vasireddi, N., et al. (2025). Emerging use of BPC-157 in orthopaedic sports medicine: a systematic review. Orthopaedic Journal of Sports Medicine.',
        citationUrl: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC12313605/',
      },
      {
      ...
      {
        title: 'Achilles Tendon Healing Study',
        protocol: 'Controlled study evaluated the effects of BPC-157 on transected Achilles tendon in rats across biomechanical, functional, microscopic, and macroscopic measures over 14 days. BPC-157 administered at 10 mcg/kg, 10 ng/kg, or 10 pg/kg intraperitoneally once daily. Controls received saline. Assessments conducted at days 1, 4, 7, 10, and 14.',
        effects: 'BPC-157 groups demonstrated superior tendon recovery compared to controls across all assessment measures. Increased load to failure, improved functional index scores, enhanced fibroblast and collagen formation, and reduced tendon defect size consistently observed across the 14-day window. No adverse findings reported at any protocol level.',
        citation: 'Sikiric, P., et al. (2003). BPC 157 accelerates healing of transected rat Achilles tendon and in vitro stimulates tendocytes growth. Journal of Orthopaedic Research, 21(6), 976–983.',
        citationUrl: 'https://pubmed.ncbi.nlm.nih.gov/14554208/',
      },
      {
      ...
      {
        title: 'Intraarticular Injection Study for Chronic Knee Pain',
        protocol: 'Retrospective observational study followed 16 subjects with various types of chronic knee pain for 6 months to over a year following a single intraarticular injection of BPC-157. 15 of 16 subjects received a 4mg research protocol. One subject received a 2mg protocol. Subjects followed for 6 months to over a year post administration.',
        effects: '14 of 16 subjects (87.5%) reported significant improvements in pain, mobility, and sleep. Effects persisted 6 months to over a year following a single administration. No adverse events reported across the subject group.',
        citation: 'Lee, J., & Padgett, B. (2021). Intraarticular injection of BPC-157 for multiple types of knee pain. Alternative Therapies in Health and Medicine, 27(4).',
        citationUrl: 'https://pubmed.ncbi.nlm.nih.gov/34254536/',
      },
    ],
    faq: [
      {
  ...
  },
  {
    ...
    researchEffects: [
      'Theorized to increase the rate of tissue repair and regeneration at injury sites, with new blood vessel formation observed in research models following VEGFR2 receptor activation',
      'Research suggests accelerated movement of fibroblasts toward damaged tissue, increasing the speed at which collagen and structural repair begins',
      'Theorized to amplify the body\'s own healing response by increasing growth hormone receptor expression on repair cells, making them more sensitive to existing signals',
      'Studies suggest a reduction in pro-inflammatory markers including TNF-α and IL-6, while preserving the early-stage inflammatory response that tissue repair requires',
      'One outlier observation from the intraarticular injection study: the subject on the 2mg protocol reported little improvement, while all subjects on the 4mg protocol reported significant results',
      'Areas of active research include musculoskeletal recovery, gastrointestinal tissue integrity, and neurological applications',
    ],
    researchFindings: [
      {
        title: 'Systematic Review of Musculoskeletal Applications',
        protocol: 'Systematic review compiled 544 published studies from 1993 to 2024, evaluating 36 that met rigorous inclusion criteria across musculoskeletal research applications. Studies evaluated across muscle, tendon, ligament, and bone models. Protocol range assessed: 6 mcg/kg to 20 mg/kg.',
        effects: 'Consistent improvements in structural, functional, and biomechanical outcomes reported across all tissue types. No toxic protocol threshold identified across the full range evaluated. Assessments across liver, kidney, brain, lung, and reproductive tissue reported no significant findings outside normal parameters.',
        citation: 'Vasireddi, N., et al. (2025). Emerging use of BPC-157 in orthopaedic sports medicine: a systematic review. Orthopaedic Journal of Sports Medicine.',
        citationUrl: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC12313605/',
      },
      {
        title: 'Achilles Tendon Healing Study',
        protocol: 'Controlled study evaluated the effects of BPC-157 on transected Achilles tendon in rats across biomechanical, functional, microscopic, and macroscopic measures over 14 days. BPC-157 administered at 10 mcg/kg, 10 ng/kg, or 10 pg/kg intraperitoneally once daily. Controls received saline. Assessments conducted at days 1, 4, 7, 10, and 14.',
        effects: 'BPC-157 groups demonstrated superior tendon recovery compared to controls across all assessment measures. Increased load to failure, improved functional index scores, enhanced fibroblast and collagen formation, and reduced tendon defect size were consistently observed across the 14-day window. No adverse findings reported at any protocol level.',
        citation: 'Sikiric, P., et al. (2003). BPC 157 accelerates healing of transected rat Achilles tendon and in vitro stimulates tendocytes growth. Journal of Orthopaedic Research, 21(6), 976–983.',
        citationUrl: 'https://pubmed.ncbi.nlm.nih.gov/14554208/',
      },
      {
        title: 'Tendon Fibroblast Migration and Growth Hormone Receptor Study',
        protocol: 'Controlled in vitro and in vivo study in rats investigated the mechanism by which BPC-157 influences tendon fibroblast behavior and growth hormone receptor expression in Achilles tendon tissue. Tendon explants and isolated fibroblasts divided into BPC-157 treated and control groups. BPC-157 applied at 2 mcg/ml. Cell outgrowth, migration, survival, and receptor expression assessed at day 7 and beyond.',
        effects: 'BPC-157 significantly accelerated tendon fibroblast outgrowth and migration compared to controls. Growth hormone receptor expression increased in a dose and time dependent manner, with effects persisting at least three days following a single application. Cell survival under oxidative stress conditions was significantly increased in the BPC-157 group. No adverse findings reported.',
        citation: 'Chang, C., et al. (2011). The promoting effect of BPC 157 on tendon healing involves tendon outgrowth, cell survival, and cell migration. Journal of Applied Physiology, 110(3), 774–780.',
        citationUrl: 'https://journals.physiology.org/doi/full/10.1152/japplphysiol.00945.2010',
      },
      {
        title: 'Myotendinous Junction Recovery Study',
        protocol: 'Controlled study in rats evaluated BPC-157 across functional, biomechanical, microscopic, and macroscopic measures following quadriceps tendon separation over 42 days. BPC-157 administered at 10 mcg/kg or 10 ng/kg intraperitoneally, or via drinking water at 0.16 mcg/ml or 0.16 ng/ml daily. Controls received saline. Assessments at days 7, 14, 28, and 42.',
        effects: 'Controls showed progressive and sustained defect with failed healing throughout the 42-day period. BPC-157 groups showed continuous improvement from the earliest assessment point, with defects fully resolving by day 28. Muscle atrophy was counteracted and fiber diversity preserved throughout. No adverse findings reported at any protocol level.',
        citation: 'Sikiric, P., et al. (2021). BPC 157 as a therapy for the disable myotendinous junctions in rats. Biomedicines, 9(11), 1547.',
        citationUrl: 'https://www.mdpi.com/2227-9059/9/11/1547',
      },
      {
        title: 'Intraarticular Injection Study for Chronic Knee Pain',
        protocol: 'Retrospective observational study followed 16 subjects with various types of chronic knee pain for 6 months to over a year following a single intraarticular injection. 15 of 16 subjects received a 4mg research protocol. One subject received a 2mg protocol. Subjects followed for 6 months to over a year post administration.',
        effects: '14 of 16 subjects (87.5%) reported significant improvements in pain, mobility, and sleep. Effects persisted 6 months to over a year following a single administration. No adverse events reported across the subject group.',
        citation: 'Lee, J., & Padgett, B. (2021). Intraarticular injection of BPC-157 for multiple types of knee pain. Alternative Therapies in Health and Medicine, 27(4).',
        citationUrl: 'https://pubmed.ncbi.nlm.nih.gov/34254536/',
      },
  ...
  },
  {
    ...
    slug: 'copper-compound',
    category: 'Specialty',
    catalogSubtitle: 'GHK-Cu',
    purity: 99.2,
    price: 49.99,
    form: 'Lyophilized Powder',
    image: '/images/copper-compound.png',
    ...
    researchFindings: [
      {
        ...
        citation: 'Maquart, F.X., et al. (1993). In vivo stimulation of connective tissue accumulation by the copper complex glycyl-L-histidyl-L-lysine in rat experimental wounds. Journal of Clinical Investigation, 92(5), 2368–2376.',
      ...
      },
      {
        ...
        citation: 'Canapp, S.O., et al. (2003). The effect of topical copper complex on healing of ischemic open wounds. Veterinary Surgery, 32(6), 515–523.',
      ...
      },
      {
        ...
        citation: 'Leyden, J.J., et al. Referenced in: Pickart, L., Vasquez-Soltero, J.M., Margolina, A. (2015). GHK as a Natural Modulator of Multiple Cellular Pathways in Skin Regeneration. BioMed Research International.',
        citationUrl: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4508379/',
      },
    ],
    faq: [
  ...
  },
  {
    ...
    price: 74.99,
    form: 'Lyophilized Powder',
    image: '/images/cjc1295-ipamorelin.png',
  ...
  },
  {
    ...
    faq: [
      {
        question: 'How should bacteriostatic water be stored and handled?',
        answer: 'Store at room temperature before opening. Once opened, store at room temperature or refrigerated and use within 28 days. Do not use if the solution appears cloudy or contains visible particles. For research use only. Not intended for human consumption.',
      },
      {
        question: 'Does the product come with handling guidance?',
      ...
      {
        question: 'What is the exact quantity in each vial?',
        answer: 'The quantity is clearly labeled on each vial and corresponds to the amount listed on the product page. Every batch is verified for identity and sterility. A Certificate of Analysis (COA) is available for each lot confirming these specifications.',
      },
      {
        question: 'What additional supplies are needed for research use?',
