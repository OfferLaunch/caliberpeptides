...
export const products: Product[] = [
  ...
  },
  {
    ...
    researchFindings: [
      ...
      },
      {
        ...
        citation: 'Treadwell, T., et al. (2012). The regenerative peptide thymosin β4 accelerates the rate of dermal healing in preclinical animal models and in patients. Annals of the New York Academy of Sciences, 1270, 37–44.',
        citationUrl: 'https://pubmed.ncbi.nlm.nih.gov/23050815/',
      },
      {
        ...
        citation: 'Sikiric, P., et al. (2003). Gastric pentadecapeptide BPC 157 accelerates healing of transected rat Achilles tendon and in vitro stimulates tendocytes growth. Journal of Orthopaedic Research, 21(6), 976–983.',
      ...
      },
      {
        ...
        citation: 'Bae, J.H., et al. (2013). Thymosin β4 enhances the healing of medial collateral ligament injury in rat. Regulatory Peptides, 183, 16–20.',
  ...
  },
  {
    ...
    researchFindings: [
      ...
      },
      {
        ...
        citation: 'Chang, C., et al. (2011). The promoting effect of pentadecapeptide BPC 157 on tendon healing involves tendon outgrowth, cell survival, and cell migration. Journal of Applied Physiology, 110(3), 774–780.',
      ...
      },
      {
        ...
        citation: 'Sikiric, P., et al. (2021). Stable gastric pentadecapeptide BPC 157 as a therapy for the disable myotendinous junctions in rats. Biomedicines, 9(11), 1547.',
  ...
  },
  {
    ...
    researchEffects: [
      ...
      'It is the broadly accepted diluent in laboratory research settings for peptide reconstitution due to its compatibility with a wide range of compounds',
    ],
    faq: [
      {
