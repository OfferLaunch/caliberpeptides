...
export default function FAQ() {
  ...
  const faqs: FAQItem[] = [
    {
      question: 'What makes Caliber Peptides different?',
      answer:
    ...
    {
      question: 'Who is eligible to purchase from Caliber Peptides?',
      answer:
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="font-body text-lg text-espresso/80">
            Everything you need to know about Caliber Peptides
          </p>
        </div>
