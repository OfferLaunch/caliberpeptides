...
const testimonials: Testimonial[] = [
  {
    text: 'Consistent quality and clear COAs. Every order has been exactly as specified. This is our go-to source for research-grade peptides.',
  ...
  {
    text: 'Clear labeling, reliable purity, and fast turnaround. Has become our default source for peptide research materials.',
