    ...
    <footer className="bg-sage text-white">
      ...
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="relative">
            ...
            <p className="mb-6 font-body text-sm text-white/80">
              Join our research community for the latest peptide insights and updates.
            </p>
          ...
          <div className="border-t border-white/20 pt-8 lg:border-t-0 lg:pt-0 lg:border-l lg:border-l-white/20 lg:pl-8">
            ...
            <address className="space-y-2 text-sm not-italic font-body">
              <p className="text-white/90">Research-Grade Peptides</p>
              <p className="text-white/80">
                Email:{" "}
                <a
                  href="mailto:support@caliberpeptides.com"
                  className="hover:text-espresso transition-colors"
                >
                  support@caliberpeptides.com
                </a>
              </p>
              <p className="text-white/80">
                Phone:{" "}
        ...
        <div className="mt-8 pt-8 text-center font-body text-xs text-white/70 space-y-4 border-t border-white/20">
          ...
          <p>
            <strong>Chemical Supplier Classification:</strong> Caliber Peptides is a chemical supplier. Caliber Peptides is not a compounding pharmacy or chemical compounding facility as defined under 503A of the Federal Food, Drug, and Cosmetic Act. Caliber Peptides is not an outsourcing facility as defined under 503B of the Federal Food, Drug, and Cosmetic Act.
          </p>
