...
**Caliber Peptides** is a marketing + e-commerce catalog website for research-grade peptides. Built with Next.js 14 App Router, TypeScript, Tailwind CSS, and Framer Motion animations.
...
interface Product {
  ...
  name: string;
  slug: string;
  category: string;        // 'GHRP', 'BPC Peptides', 'Recovery Peptides', etc.
